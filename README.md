...
For database, better to use something like MySQL. The database should be automatically updated with SharpTimer migrations file, in case it doesn't, you can use the SQL file that should work for MySQL 8 to create a template database. _(example.sql)_
...
RampBugFix [https://github.com/Interesting-exe/CS2Fixes-RampbugFix/](https://github.com/rcnoob/CS2Fixes-RampbugFix/)
